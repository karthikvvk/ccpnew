          ...
          >
            ...
            >
              ...
              <div className="relative bg-[#0f172a] rounded-[2.5rem] p-[8px] shadow-2xl shadow-slate-900/50">
                ...
                <div className="absolute -left-[3px] top-28 w-[3px] h-40 bg-slate-700 rounded-l-sm"></div>
                ...
                <div className="relative rounded-[2rem] overflow-hidden aspect-[9/19.5] bg-black">
                  ...
                  <div className="relative w-full h-full bg-black flex items-center justify-center">
                    ...
                    <button
                      onClick={togglePlayPause}
                      className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center transition-all hover:bg-white/30 hover:scale-110 pointer-events-auto z-40"
                    >
                    ...
                    {/* Progress Bar */}
                    <div className="absolute bottom-20 left-4 right-4 pointer-events-auto z-40">
                      <div
                        className="w-full h-1 bg-white/20 rounded-full cursor-pointer overflow-hidden backdrop-blur-sm"
                    ...
                    <div className="absolute bottom-2 left-1/2 -translate-x-1/2 w-[120px] h-[4px] bg-white/80 rounded-full pointer-events-none"></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6" style={{ transform: 'translateZ(50px)', transformStyle: 'preserve-3d' }}>
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl transform -rotate-2 hover:rotate-0 transition-all">
                ...
                <div className="absolute top-4 left-4 glass px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest flex items-center gap-1.5">
                  ...
                  <span className="text-slate-800">TAMIL</span>
                </div>
              </div>
            </div>
          </div>
